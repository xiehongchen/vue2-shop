    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
          ...
          <!-- 分页的地方 -->
          <div class="fr page">
            <!-- total:总页数,pageSize:每页展示数据,currentPage:当前页码,pagerCount:连续页码数,连续显示5个页码 -->
            <Pagination
              :total="total"
...
export default {
  ...
  //组件挂载完毕次钩子执行一次,发请求（仅执行一次，因此获取search模块数据不能在这）
  mounted() {
    //在发请求之前:整理用户搜索的参数
    //组件挂载完毕发一次请求
    this.getData();
  ...
  methods: {
    ...
    removeCategoryName() {
      ...
      //这里是要改变路径，因为只删除了面包屑，但路径信息没有发生变化，因此需要变化路径，也就是路由跳转，自己跳转自己即可
  ...
  watch: {
    ...
    $route() {
      ...
      //每一次请求完毕之后，都需要把相应的分类的id置空，让它接收下一次的相应的分类的id
      // 这里设置为undefined，这样带给服务器就不包含这三个，优化请求、性能
      this.searchParams.category1Id = undefined;
      this.searchParams.category2Id = undefined;
      this.searchParams.category3Id = undefined;
      //分类名字和关键名字不用清理，因为每一次路由发生变化的时候，都会给它赋予新的数据
